   ...
   if(errors.length === 0 ){
    ...
    return (
        <div>
            ...
            <AvField name="email" placeholder="Email" type="email" autoComplete="off" value={props.email}
            ...
            validate={{
                ...
                autoComplete="off" onChange={e => props.setPassword(e.target.value)} value={props.password}
                 validate={{
